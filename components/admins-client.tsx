...
export function AdminsClientComponent({ initialAdmins }: AdminsClientComponentProps) {
  ...
  return (
    <>
      ...
      <AdminModal open={modalOpen} onOpenChange={setModalOpen} admin={selectedAdmin} onSuccess={handleSuccess} />
