...
import { Users, BookOpen, Briefcase, DollarSign, AlertCircle, Loader2 } from "lucide-react"
    ...
    <>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        <Card className="p-6 border-l-4 border-l-blue-500">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold text-foreground">{stats?.students || 0}</p>
            </div>
        ...
        <Card className="p-6 border-l-4 border-l-indigo-500">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold text-foreground">{stats?.teachers || 0}</p>
            </div>
        ...
        <Card className="p-6 border-l-4 border-l-green-500">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-muted-foreground text-sm font-medium mb-1">Total Classes</p>
              <p className="text-3xl font-bold text-foreground">{stats?.classes || 0}</p>
            </div>
        ...
        <Card className="p-6 border-l-4 border-l-purple-500">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-muted-foreground text-sm font-medium mb-1">Fees Collected</p>
              <p className="text-3xl font-bold text-foreground">₹{(stats?.fees.paid || 0).toLocaleString()}</p>
            </div>
