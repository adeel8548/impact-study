...
export function TeacherDashboardCharts({ attendanceData, classDistribution }: TeacherDashboardChartsProps) {
  return (
    <>
      {/* Attendance Trend */}
      <Card className="p-6">
      ...
      {/* Class Distribution */}
      <Card className="p-6">
        <h3 className="text-lg font-bold text-foreground mb-4">Students per Class</h3>
        <ResponsiveContainer width="100%" height={300}>
