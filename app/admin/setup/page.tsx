        ...
        <Card>
          ...
          <CardContent className="space-y-6">
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
              <h3 className="font-semibold text-blue-900 mb-2">Test Users to Create:</h3>
            ...
            <Button onClick={handleCreateUsers} disabled={loading} size="lg" className="w-full">
            ...
            {result && (
              <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                <p className="font-semibold text-green-900 mb-3">{result.message}</p>
                <div className="space-y-2">
                  {result.users.map((user: any, idx: number) => (
                    <div key={idx} className="bg-white p-3 rounded border border-green-100 text-sm">
                      <p className="font-mono font-semibold text-green-700">{user.email}</p>
                      {user.status === "created" ? (
                        <>
